...
public class TextComponentUtil {
    ...
    private static MutableComponent getTranslatedBoolean(boolean bool) {
        return (bool ? ModLang.TRUE_LOWER : ModLang.FALSE_LOWER).translate();
    }

    private static MutableComponent getTranslatedDirection(Direction direction) {
        return (switch (direction) {
            case DOWN -> ModLang.DOWN;
            case UP -> ModLang.UP;
            case NORTH -> ModLang.NORTH;
            case SOUTH -> ModLang.SOUTH;
            case WEST -> ModLang.WEST;
            case EAST -> ModLang.EAST;
        }).translate();
    }
