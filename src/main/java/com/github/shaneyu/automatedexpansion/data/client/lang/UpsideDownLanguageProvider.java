...
import com.github.shaneyu.automatedexpansion.data.client.lang.FormatSplitter.FormatComponent;
import com.github.shaneyu.automatedexpansion.data.client.lang.FormatSplitter.MessageFormatComponent;
...
public class UpsideDownLanguageProvider extends ConvertibleLanguageProvider {
    ...
    public UpsideDownLanguageProvider(DataGenerator gen) {
        super(gen, "en_ud");
    ...
    private static String convertMessageFormatCode(MessageFormatComponent component) {
        ...
        if (formatStyle != null && component.isChoice()) {
            ...
            try {
                ...
                AutomatedExpansion.LOGGER.warn("Failed to convert '{}' to an upside down choice format. Got: '{}' which was invalid.", formatStyle, newFormatStyle);
